...
globalThis.Z = async function(r) {
  ...
  if (req.photo && v.ref && v.ll) {
    ...
    nn = ''
req.photo = `https://res.cloudinary.com/o6/image/fetch/w_960/g_north,l_${v.pic},y_-480/b_rgb:f5e6e4,c_fill,co_black,g_north,l_text:ubuntu%20mono_96_center:${t},w_960/${nn}${req.photo}`
//
